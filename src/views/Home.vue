      ...
      <section class="w-full min-h-full">
        ...
        <section class="pb-16" :class="'bg' + currentPalette[1]">
          <div class="w-4/5 m-auto py-8">
            ...
            <div class="px-6 py-10 mb-4 rounded" :class="'bg' + currentPalette[0]" v-for="index in 5" :key="index">
        ...
        <section class="pb-16" :class="'bg' + currentPalette[0]">
          <div class="w-4/5 m-auto">
            ...
            <div class="px-6 py-10 mb-4 rounded" :class="'bg' + currentPalette[1]" v-for="index in 8" :key="index">
        ...
        <section class="pb-16" :class="'bg' + currentPalette[1]">
          <div class="w-4/5 m-auto">
            <div class="flex justify-between mb-6">
              ...
              <svg xmlns="http://www.w3.org/2000/svg" class="w-64 h-64 icon icon-tabler icon-tabler-photo stroke-current" :class="'text' + currentPalette[0]" viewBox="0 0 24 24" stroke-width="1.5" fill="none" stroke-linecap="round" stroke-linejoin="round">
                <path stroke="none" d="M0 0h24v24H0z"/>
                <line x1="15" y1="8" x2="15.01" y2="8" />
                <rect x="4" y="4" width="16" height="16" />
                <path d="M4.2 15l4 -4a3 5 0 0 1 3 0l 5 5" />
            ...
            <div class="mb-6">
              ...
              <div class="flex">
                <div class="w-1/3 px-6 py-10 mr-2 rounded" :class="'bg' + currentPalette[0]" v-for="index in 3" :key="index">
            ...
            <div class="mb-6">
              ...
              <form @submit.prevent="" class="flex items-end">
                <div class="flex flex-col w-5/12 mr-1">
                  <label class="font-bold mb-2" :class="'text' + currentPalette[0]" for="name">First Name</label>
                ...
                <div class="flex flex-col w-5/12 mr-1">
                  <label class="font-bold mb-2" :class="'text' + currentPalette[0]" for="email">First Name</label>
                ...
                <button class="h-16 w-2/12 rounded font-bold focus:outline-none" :class="['bg' + currentPalette[2], 'text' + currentPalette[1]]">Subscribe</button>
              </form>
            </div>
          </div>
        </section>
