    ...
    <main class="w-full h-full overflow-x-auto" ref="top">
      ...
      <div class="flex w-full h-16" :class="'bg' + currentPalette[0]">
        <button @click="toggleSidebar" class="text-white font-bold focus:outline-none ">
          <!-- Menu Icon -->
          <svg v-show="!showAsideBar" xmlns="http://www.w3.org/2000/svg" class="w-12 h-12 ml-2 icon icon-tabler icon-tabler-arrow-bar-right stroke-current" :class="'text' + currentPalette[1]" viewBox="0 0 24 24" stroke-width="1.5" fill="none" stroke-linecap="round" stroke-linejoin="round">
          ...
          <!-- Left Arrow Icon -->
          <svg v-show="showAsideBar" xmlns="http://www.w3.org/2000/svg" class="w-24 h-12 icon icon-tabler icon-tabler-arrow-bar-left stroke-current" :class="'text' + currentPalette[1]" viewBox="0 0 24 24" stroke-width="1.5" fill="none" stroke-linecap="round" stroke-linejoin="round">
            <path stroke="none" d="M0 0h24v24H0z"/>
